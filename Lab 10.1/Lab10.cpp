//
// Created by Timur Oshnokov on 2019-06-01.
//
...
template<typename ValueType, class Compare>
typename AVLSet<ValueType, Compare>::Item *AVLSet<ValueType, Compare>::LeftSmallRotate(Item *par) {
    Item *p_l = par->left_;
    Item *p_r = par->right_;
...
template<typename ValueType, class Compare>
typename AVLSet<ValueType, Compare>::Item *AVLSet<ValueType, Compare>::LeftBigRotate(Item *par) {
    Item *p_l = par->left_;
    Item *p_r = par->right_;
    Item *p_r_left = p_r->left_;
    Item *p_r_right = p_r->right_;
...
template<typename ValueType, class Compare>
typename AVLSet<ValueType, Compare>::Item *AVLSet<ValueType, Compare>::RightSmallRotate(Item *par) {
    Item *p_l = par->left_;
    Item *p_r = par->right_;
...
template<typename ValueType, class Compare>
typename AVLSet<ValueType, Compare>::Item *AVLSet<ValueType, Compare>::RightBigRotate(Item *par) {
    Item *p_l = par->left_;
    Item *p_r = par->right_;
    Item *p_l_left = p_l->left_;
    Item *p_l_right = p_l->right_;
...
int main() {
    ...
    for (int i = 0; i < actions; i++) {
        ...
        if (command == 'A') {
            ...
            else cout << "This value was found" << endl << endl;
